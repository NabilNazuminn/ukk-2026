...
<div class="wrap">
    <div class="section">
        ...
        <p style="font-size:1.1rem;font-weight:700;margin-bottom:16px">Dashboard — Semua Pengaduan</p>

        <!-- STATISTIK -->
        <div class="stat-grid">
            <div class="stat-card" style="border-top:3px solid var(--cyan)">
                <div class="s-label">Total</div>
                <div class="s-val" style="color:var(--cyan)"><?= $total ?></div>
            </div>
            <div class="stat-card" style="border-top:3px solid var(--kuning)">
                <div class="s-label">Menunggu</div>
                <div class="s-val" style="color:var(--kuning)"><?= $menunggu ?></div>
            </div>
            <div class="stat-card" style="border-top:3px solid var(--ungu)">
                <div class="s-label">Diproses</div>
                <div class="s-val" style="color:var(--ungu)"><?= $proses ?></div>
            </div>
            <div class="stat-card" style="border-top:3px solid var(--hijau)">
